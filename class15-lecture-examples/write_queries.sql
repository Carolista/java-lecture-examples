-- Write a query to display the first and last names of artists 
...
-- Write a query to display the title, artist, and style of each artwork created in 1939
...
/* Write queries to handle table updates when putting works on exhibit */
...
-- Change the @artist to another artist and re-run the addition of the exhibit_id for those artworks

-- Get total number of artworks assigned to @exhibit and return with exhibit title
